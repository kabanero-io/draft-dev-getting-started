...
Running docker command: docker run --rm -P --name nodejs-dev -v /Users/myuser/workspace/kabanero-workshop/nodejs/:/project/user-app -v nodejs-deps:/project/user-app/node_modules -v /Users/myuser/.appsody/appsody-controller:/appsody/appsody-controller -t --entrypoint /appsody/appsody-controller kabanero/nodejs-express:0.2 --mode=run
...
Running command: docker create --name nodejs-extract -v /Users/myuser/workspace/kabanero-workshop/nodejs/:/project/user-app dev.local/nodejs-express:SNAPSHOT
...
[source, role="no_copy"]
....
drwxr-xr-x   10 myuser  staff    320 Oct  3 17:55 .
drwxr-xr-x   11 myuser  staff    352 Oct  8 14:15 ..
-rw-r--r--    1 myuser  staff     48 Oct  3 14:41 .dockerignore
-rw-r--r--    1 myuser  staff    878 Oct  3 14:41 Dockerfile
drwxr-xr-x  274 myuser  staff   8768 Oct  3 17:55 node_modules
-rw-r--r--    1 myuser  staff  92237 Oct  3 17:55 package-lock.json
-rw-r--r--    1 myuser  staff    659 Oct  3 14:41 package.json
-rw-r--r--    1 myuser  staff   1462 Oct  3 14:41 server.js
drwxr-xr-x    3 myuser  staff     96 Oct  3 14:41 test
drwxr-xr-x   10 myuser  staff    320 Oct  8 14:04 user-app
....
